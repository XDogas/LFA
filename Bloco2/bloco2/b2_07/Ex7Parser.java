...
public class Ex7Parser extends Parser {
	...
	public static class StatExprContext extends StatContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Ex7Listener ) ((Ex7Listener)listener).enterStatExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Ex7Listener ) ((Ex7Listener)listener).exitStatExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Ex7Visitor ) return ((Ex7Visitor<? extends T>)visitor).visitStatExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class StatAssignContext extends StatContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Ex7Listener ) ((Ex7Listener)listener).enterStatAssign(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Ex7Listener ) ((Ex7Listener)listener).exitStatAssign(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Ex7Visitor ) return ((Ex7Visitor<? extends T>)visitor).visitStatAssign(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__2:
				...
				setState(30);
				((ExprUnaryContext)_localctx).s = _input.LT(1);
				_la = _input.LA(1);
				if ( !(_la==T__1 || _la==T__2) ) {
					((ExprUnaryContext)_localctx).s = (Token)_errHandler.recoverInline(this);
				}
				else {
