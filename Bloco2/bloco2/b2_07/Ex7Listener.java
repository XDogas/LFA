...
public interface Ex7Listener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link Ex7Parser#stat}.
	 * @param ctx the parse tree
	 */
	void enterStatExpr(Ex7Parser.StatExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StatExpr}
	 * labeled alternative in {@link Ex7Parser#stat}.
	 * @param ctx the parse tree
	 */
	void exitStatExpr(Ex7Parser.StatExprContext ctx);
	/**
	 * Enter a parse tree produced by the {@code StatAssign}
	 * labeled alternative in {@link Ex7Parser#stat}.
	 * @param ctx the parse tree
	 */
	void enterStatAssign(Ex7Parser.StatAssignContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StatAssign}
	 * labeled alternative in {@link Ex7Parser#stat}.
	 * @param ctx the parse tree
	 */
	void exitStatAssign(Ex7Parser.StatAssignContext ctx);
	/**
